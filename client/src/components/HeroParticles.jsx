...
const ParticleField = () => {
  ...
  const [positions, colors, sizes] = useMemo(() => {
    ...
    for (let i = 0; i < count; i++) {
      ...
      if (temp > 0.8) {
        colors[i3] = 1.0; colors[i3 + 1] = 0.2; colors[i3 + 2] = 0.1;
      } else if (temp > 0.6) {
        colors[i3] = 1.0; colors[i3 + 1] = 0.5; colors[i3 + 2] = 0.2;
      } else if (temp > 0.35) {
        colors[i3] = 1.0; colors[i3 + 1] = 0.75; colors[i3 + 2] = 0.3;
      } else {
        colors[i3] = 0.7; colors[i3 + 1] = 0.7; colors[i3 + 2] = 0.75;
      }
